...
import { HOME, RVSITE_DETAILS, RVSITE_LIST, EDIT_RVSITE_DETAILS, MAIN_SCREEN, RVSITE_MAP } from '../constants/Constants.js';
...
import RVSiteMapScreen from '../screens/RVSiteMapScreen/index.js';
...
const HomeScreenNavigator= () => {
    ...
    return (
        <HomeStack.Navigator initialRouteName={HOME}>
            ...
            <HomeStack.Screen name={RVSITE_MAP} component={RVSiteMapScreen}/>
